...
📄 Dashboard Overview & Business Insights For a complete view of all dashboard pages(Executive Dashboard,Patients Analytics ,	Doctor & Department Performance,Billing & Revenue,Business Insights) see:dashboard_view.pdf
